...
resource kvSecretReader 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  ...
  properties: {
    ...
    roleDefinitionId: subscriptionResourceId('Microsoft.Authorization/roleDefinitions', '') // Key Vault Secrets User
...
resource logicAppCaller 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  ...
  properties: {
    ...
    roleDefinitionId: subscriptionResourceId('Microsoft.Authorization/roleDefinitions', '') // Reader + Function Invoke
    principalType: 'ServicePrincipal'
  }
}
